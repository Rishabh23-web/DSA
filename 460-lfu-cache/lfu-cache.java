...
class LFUCache {
    ...
    private Map<Integer, DLList> freqListMap; // Hashmap to maintain the lists with different frequencies
    ...
    private void updateFreqListMap(Node node) {
        ...
        DLList nextHigherFreqList = new DLList();
    ...
    public void put(int key, int value) {
        ...
        if (keyNode.containsKey(key)) {
            ...
            if (curSize == maxSizeCache) {
                ...
                DLList list = freqListMap.get(minFreq);
